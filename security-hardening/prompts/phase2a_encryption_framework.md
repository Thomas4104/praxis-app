Du bist ein Kryptographie-Experte. Dein Auftrag: Ein Feld-Level-Verschluesselungs-Framework fuer /Users/thomasbalke/praxis-app erstellen.

WICHTIG: Lies IMMER zuerst bestehende Dateien, bevor du etwas aenderst oder erstellst.

## Aufgabe 1: Encryption-Utility erstellen
Erstelle: /Users/thomasbalke/praxis-app/utils/encryption.py
...
class EncryptedField:
    """SQLAlchemy TypeDecorator fuer transparente Feld-Verschluesselung.

    Verwendung in models.py:
        ahv_number = db.Column(EncryptedString(), nullable=True)
    """
    pass  # Wird in Phase 2b als TypeDecorator implementiert
```

## Aufgabe 2: SQLAlchemy TypeDecorator implementieren
Erweitere die Datei um einen vollstaendigen TypeDecorator:
...
## Aufgabe 3: Dependency hinzufuegen
Datei: /Users/thomasbalke/praxis-app/requirements.txt
Fuege hinzu (lies die Datei zuerst!):
```
cryptography>=42.0.0
```

## Aufgabe 4: Config erweitern
Datei: /Users/thomasbalke/praxis-app/config.py
Fuege in der Config-Basisklasse hinzu:
```python
ENCRYPTION_KEY = os.environ.get('ENCRYPTION_KEY', '')
```

## Aufgabe 5: .env.example erweitern
Fuege ENCRYPTION_KEY Dokumentation hinzu.

## Reihenfolge:
1. Lies requirements.txt und config.py zuerst
2. Erstelle utils/encryption.py
3. Aktualisiere requirements.txt
4. Aktualisiere config.py
5. Syntax-Check: python3 -c "import ast; ast.parse(open('/Users/thomasbalke/praxis-app/utils/encryption.py').read())"
